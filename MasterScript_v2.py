...
def GetExperimentList(N, start_mos, k_mos, k_cell, k_bfactor, beam_func, frames, \
    radial_symmetry=True, osc=0.01):
    """
    IT DEALS WITH ONLY THE PARAMS CHANGING DURING THE RUN???
...
def GetHomogenousExperimentList(start_mos,k_mos,k_cell,k_bfactor,frames,osc=0.01):
    """
...
def SpacialDependentCrystal(N,start_mos,k_mos,k_cell,k_bfactor,beam_func,frames,\
    ...
    WriteDescription(N, start_mos, k_mos,k_cell, k_bfactor, beam_func, frames,\
