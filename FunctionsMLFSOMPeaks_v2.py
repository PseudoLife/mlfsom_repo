...
class mlfsomXYI:
	...
	def PlotPeakIntensities(self,df_peaks,first_N_peaks=None,save_img=False):
		"""
	...
	def PlotIntegratedIntensities(self,df_peaks,scale='log',save_img=False):
		"""
	...
	def PlotShellIntensities(self,df_peaks,N_shells=10,normalized=True,save_img=False):
		"""
	...
	def PlotDhalfvsResolution(self,df_peaks,N_shells=10,K=1.4,weights=(0.75,0.25),save_img=False):
		"""
