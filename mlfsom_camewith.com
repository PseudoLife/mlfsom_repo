#! /bin/tcsh -f
#
#	convert a merged .mtz file into ADSC formatted images	- James Holton 9-5-15
#
#
...
set outprefix    = /Users/matt/Desktop/development_snapshot/myfake
...
set record = `echo $dimx | awk '{print $1*2}'`
...
awk -f hkl2XYphi.awk ${tempfile}predin.txt | tee ${tempfile}_preds.txt | awk '$1!=last{print;last=$1}'
...
awk '$3=="i"{print int($1),$2}' ${tempfile}plotout |\
