...
def PlotPeakIntensities(df_mlfsomPeaks,first_N_peaks=None):
	'''
...
def PlotIntegratedIntensities(df_mlfsomPeaks,scale='log'):
	"""
...
def PlotShellIntensities(df_mlfsomPeaks,N_shells=10):
	"""
